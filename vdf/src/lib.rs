...
/// sizes.
const INCORRECT_BUFFER_SIZE: &str = "internal error: incorrect buffer size calculation (this is a bug)";
...
pub trait VDF: Send + Debug {
  ...
  fn calculate_y(&self, challenge: &[u8], difficulty: u64) -> Result<Vec<u8>, InvalidIterations>;
